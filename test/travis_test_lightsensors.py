...
class LightsensorTest(unittest.TestCase):
    ...
    def check_values(self, lf, ls, rs, rf):
        ...
        self.assertEqual(vs.right_side, ls, "different value: right_side")
        self.assertEqual(vs.right_forward, ls, "different value: right_forward")
        self.assertEqual(vs.sum_all, ls, "different value: sum_all")
        self.assertEqual(vs.sum_forward, ls, "different value: sum_forward")
    ...
    def test_get_value(self):
        rospy.set_param('lightsensors_freq', 10)    #センサの値取得の周期を10[Hz]に
    ...
    def test_change_parameter(self):
        rospy.set_param('lightsensors_freq', 1) #センサの値取得の周期を1[Hz]に
        time.sleep(2)                           #パラメータの反映を待つ
