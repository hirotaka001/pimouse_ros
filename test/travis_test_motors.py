...
class MotorTest(unittest.TestCase):
    ...
    def test_put_cmd_vel(self):     #cmd_velのテスト
        ...
        self.file_check("rtmotor_raw_l0", 0, "wrong left value from cmd_vel")
        self.file_check("rtmotor_raw_r0", 0, "wrong right value from cmd_vel")
    ...
    def test_put_value_timed(self):
        ...
        with open("/dev/rtmotor0", "r") as f:
            data = f.readline()
            self.assertEqual(data, "-321 654 1500\n", "value does not written to rtmotors")
